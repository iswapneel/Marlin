 ...
 */
  ...
  #define BABYSTEP_DISPLAY_TOTAL   //iswap       // Display total babysteps since last G28
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100  // iswap (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   50  //iswap (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      940        // iswap for tmc2208
    #define E0_MICROSTEPS    16
   ...
   */
  #define SQUARE_WAVE_STEPPING //iswap
